            ...
            if (order.customer.equals(customer)) {
                ...
                if (isReturn) {
                    if (assignedLocker.returnCode.equals(enteredCode)) {
                        ...
                        System.out.println("Notification to " + order.customer.getEmail() + " : RefundSuccesfull");
                    ...
                    if (isValid) {
                        ...
                        System.out.println("Notification to " + order.customer.getEmail() + " : Pickup Successfull!!");
                        assignedLocker.isOccupied = false;
                    } else {
